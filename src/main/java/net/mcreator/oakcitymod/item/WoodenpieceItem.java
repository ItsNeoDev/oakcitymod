...
public class WoodenpieceItem extends OakCityModModElements.ModElement {
	@ObjectHolder("oak_city_mod:woodenpiece")
	public static final Item block = null;
	public WoodenpieceItem(OakCityModModElements instance) {
		super(instance, 3);
	}

...
package net.mcreator.oakcitymod.particle;
...
public class BloodParticle extends OakCityModModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public BloodParticle(OakCityModModElements instance) {
		super(instance, 11);

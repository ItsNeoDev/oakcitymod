...
public class BirchCoinItem extends OakCityModModElements.ModElement {
	@ObjectHolder("oak_city_mod:birch_coin")
	public static final Item block = null;
	public BirchCoinItem(OakCityModModElements instance) {
		super(instance, 29);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("5 Dollars"));
		}
	}
}

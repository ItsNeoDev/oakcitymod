...
public class IronbulletItem extends OakCityModModElements.ModElement {
	@ObjectHolder("oak_city_mod:ironbullet")
	public static final Item block = null;
	public IronbulletItem(OakCityModModElements instance) {
		super(instance, 6);
	}

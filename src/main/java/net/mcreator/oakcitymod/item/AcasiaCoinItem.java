...
public class AcasiaCoinItem extends OakCityModModElements.ModElement {
	@ObjectHolder("oak_city_mod:acasia_coin")
	public static final Item block = null;
	public AcasiaCoinItem(OakCityModModElements instance) {
		super(instance, 32);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("50 Dollars"));
		}
	}
}

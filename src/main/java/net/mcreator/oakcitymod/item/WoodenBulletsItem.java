...
public class WoodenBulletsItem extends OakCityModModElements.ModElement {
	@ObjectHolder("oak_city_mod:wooden_bullets")
	public static final Item block = null;
	public WoodenBulletsItem(OakCityModModElements instance) {
		super(instance, 2);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("wooden_bullets");
		}

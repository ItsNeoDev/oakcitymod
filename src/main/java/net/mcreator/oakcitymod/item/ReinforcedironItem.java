...
public class ReinforcedironItem extends OakCityModModElements.ModElement {
	@ObjectHolder("oak_city_mod:reinforcediron")
	public static final Item block = null;
	public ReinforcedironItem(OakCityModModElements instance) {
		super(instance, 14);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("reinforcediron");
		}

...
public class JungleCoinItem extends OakCityModModElements.ModElement {
	@ObjectHolder("oak_city_mod:jungle_coin")
	public static final Item block = null;
	public JungleCoinItem(OakCityModModElements instance) {
		super(instance, 31);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("25 Dollars"));
		}
	}
}

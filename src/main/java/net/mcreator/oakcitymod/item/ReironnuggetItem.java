...
public class ReironnuggetItem extends OakCityModModElements.ModElement {
	@ObjectHolder("oak_city_mod:reironnugget")
	public static final Item block = null;
	public ReironnuggetItem(OakCityModModElements instance) {
		super(instance, 23);
	}
